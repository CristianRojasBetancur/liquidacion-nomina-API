...
class CompanyTest < ActiveSupport::TestCase
  ...
  test 'has_many workers relation' do
    assert_equal [@worker_one, @worker_two], @company.workers, "Company must have property 'user'"
  end

  test 'has_many periods relation' do
    assert_equal [@period_one], @company.workers, "Company must have property 'user'"
  end
