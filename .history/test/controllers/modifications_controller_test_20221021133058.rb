...
class ModificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create valid modification" do
    assert_difference("Modification.count") do
      post '/modifications', params: { modification: { deductions: @modification.deductions, no_salary_incomes: @modification.no_salary_incomes, other_salary_incomes: @modification.other_salary_incomes, period_id: @modification.period_id, worker_id: @modification.worker_id } }, as: :json
    end
