...
class PayrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payroll" do
    assert_difference("Payroll.count") do
      post '/payrolls', params: { payroll: { employeed_payment: @payroll.employeed_payment, parafiscal_cont: @payroll.parafiscal_cont, period_id: @payroll.period_id, reten_deduc: @payroll.reten_deduc, social_benefits: @payroll.social_benefits, social_security: @payroll.social_security, total_payrolls: @payroll.total_payrolls } }, as: :json
    end
