  ...
  def settle_payroll
    ...
    if @current_user.company.workers == []
      ...
      @current_user.company.workers.each do |worker|
        ...
        other_salary_income = worker.modification.other_salary_incomes if worker.modification != nil# Por ahora cero luego sera segun las modficaciones del empleado
